      ...
      <Col md={3} className="d-none d-md-block">
        <Card>
          <Card.Body>
            ...
            <Card.Link href="https://www.linkedin.com/in/salvatore-alessandro-d-amico-4a1551267">
              Public profile & URL
            </Card.Link>
          </Card.Body>
        </Card>
        <Card className="mb-2">
          <Card.Body>
            ...
            <ListGroup variant="flush">
              {/* Ripeti questo ListGroupItem per ogni profilo */}
              <ListGroup.Item>
                <Row>
                  <Col xs={3}>
                  ...
                  <Col>
                    {/* Nome e dettagli del profilo */}
                    <div>Stefano Miceli</div>
                    <div className="text-muted">Front-end Developer & Creative Director</div>
                    <Link to="/messages" className="btn btn-link p-0">
                      Messaggio
                    </Link>
                  </Col>
                </Row>
              ...
              {/* ... altri ListGroupItem per altri profili ... */}
            </ListGroup>
          </Card.Body>
        </Card>
      </Col>
