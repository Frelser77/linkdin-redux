...
import { CardBody, CardText, Col, Form, FormText, Image, Modal, Row } from "react-bootstrap";
				...
				<Col>
					...
					<Card className="mb-2 shadow">
						...
						<Button className="nav-link my-link border border-1 border-secondary border-start-0 border-bottom-0 border-end-0 d-flex align-items-center justify-content-center fw-semibold">
							<NavLink to={"/risorse"} className="nav-link undecorated my-2 ">
					...
					<Card className="mb-2 shadow p-2">
						<Card.Title className="fs-4 d-flex justify-content-between align-items-center mx-2 my-1">
							...
							{location.pathname === "/profile/me" && (
								<div>
									<Button className="me-2 pencil px-2 fs-2">
										<GoPlus />
									</Button>
									<Button className="pencil px-2 fs-4">
										<GoPencil />
									</Button>
								</div>
							)}
					...
					<Card>
						<Card.Body>
							...
							<ListGroup variant="flush">
								...
								<ListGroup.Item>
									HTML5 Confermata da 1 persone negli ultimi 6 mesi
									<span style={{ float: "right" }}>1 conferma</span>
								</ListGroup.Item>
							</ListGroup>
						</Card.Body>
						<Button className="nav-link my-link d-flex align-items-center justify-content-center fw-semibold border border-1 border-secondary border-start-0 border-bottom-0 border-end-0">
							<NavLink to={"/risorse"} className="nav-link undecorated my-2">
								Mostra tutte le risorse(5)
								<ArrowRight className="fs-6 ms-1" />
							</NavLink>
