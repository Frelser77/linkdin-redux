...
import { CardText, Col, Form, FormText, Modal, Row } from "react-bootstrap";
			...
			<Modal show={show} onHide={handleClose} dialogClassName="my-custom-modal">
				...
				<Modal.Body>
					<Form className="mx-2">
						...
						<Form.Group className="my-3 d-flex align-items-baseline" controlId="exampleForm.ControlInput1">
							<Linkedin className="ms-1 me-4 fs-5" />
						...
						<Form.Group className="mb-3 d-flex align-items-baseline" controlId="exampleForm.ControlInput2">
							<FaPhoneAlt className="ms-1 me-4 fs-5" />
							<Form.Label className="fw-semibold">
								Telefono
						...
						<Form.Group className="mb-3 d-flex align-items-baseline" controlId="exampleForm.ControlInput3">
							<MdOutlineEmail className="ms-1 me-4 fs-4" />
							<Form.Label className="fw-semibold">
								Email
						...
						<Form.Group className="mb-3 d-flex align-items-baseline" controlId="exampleForm.ControlInput4">
							<ImCalendar className="ms-1 me-4 fs-5" />
							<Form.Label className="fw-semibold">
								Compleanno
